...
static MC2_PROC_PTR<void> mc2___security_init_cookie(0x00625D30);

static auto &mc2__cfltcvt_tab = MC2_GLOBAL<MC2_PROC_PTR<void, double *, char *, int, int, int>>(0x00679D18);
static auto &mc2__cropzeros_tab = MC2_GLOBAL<MC2_PROC_PTR<void, char *>>(0x00679D1C);
static auto &mc2__fassign_tab = MC2_GLOBAL<MC2_PROC_PTR<void, int, char *, char *>>(0x00679D20);
static auto &mc2__forcdecpt_tab = MC2_GLOBAL<MC2_PROC_PTR<void, char *>>(0x00679D24);
static auto &mc2__positive_tab = MC2_GLOBAL<MC2_PROC_PTR<int, double *>>(0x00679D28);
static auto &mc2__cldcvt_tab = MC2_GLOBAL<MC2_PROC_PTR<void, double *, char *, int, int, int>>(0x00679D20);

static MC2_PROC_PTR<void> mc2__fptrap(0x00624670);
static MC2_PROC_PTR<void, double *, char *, int, int, int> mc2__cfltcvt(0x0061C725);
static MC2_PROC_PTR<void, char *> mc2__cropzeros(0x0061C3EB);
static MC2_PROC_PTR<void, int, char *, char *> mc2__fassign(0x0061C450);
static MC2_PROC_PTR<void, char *> mc2__forcdecpt(0x0061C393);
static MC2_PROC_PTR<int, double *> mc2__positive(0x0061C436);
...
static const MC2_PROC_PTR<int> xi[] = {
...
MC2_DEF_GLOBAL(glo_692E80, 0x00692E80); // = sqrt_12_constant
MC2_DEF_GLOBAL(glo_692EAC, 0x00692EAC); // = sqrt_12_constant
MC2_DEF_GLOBAL(glo_692EBC, 0x00692EBC); // = sqrt_12_constant
MC2_DEF_GLOBAL(glo_692EC4, 0x00692EC4); // = sqrt_12_constant
MC2_DEF_GLOBAL(glo_692EC8, 0x00692EC8); // = sqrt_12_constant
MC2_DEF_GLOBAL(glo_696764, 0x00696764); // = sqrt_12_constant
MC2_DEF_GLOBAL(glo_6967B0, 0x006967B0); // = sqrt_12_constant
MC2_DEF_GLOBAL(glo_696850, 0x00696850); // = sqrt_12_constant
MC2_DEF_GLOBAL(glo_697B8C, 0x00697B8C); // = sqrt_12_constant
MC2_DEF_GLOBAL(glo_697C18, 0x00697C18); // = sqrt_12_constant
MC2_DEF_GLOBAL(glo_698490, 0x00698490); // = sqrt_12_constant
MC2_DEF_GLOBAL(glo_698620, 0x00698620); // = sqrt_12_constant
MC2_DEF_GLOBAL(glo_69910C, 0x0069910C); // = sqrt_12_constant
MC2_DEF_GLOBAL(glo_6993A0, 0x006993A0); // = sqrt_12_constant
MC2_DEF_GLOBAL(glo_69948C, 0x0069948C); // = sqrt_12_constant
MC2_DEF_GLOBAL(glo_699690, 0x00699690); // = sqrt_12_constant
MC2_DEF_GLOBAL(glo_69B5F8, 0x0069B5F8); // = sqrt_12_constant
MC2_DEF_GLOBAL(glo_699860, 0x00699860); // = 200.0f
MC2_DEF_GLOBAL(glo_69B698, 0x0069B698); // = (44.704f / -26.8224f) * -0.5f
MC2_DEF_GLOBAL(glo_69988C, 0x0069988C); // = 5.0f
MC2_DEF_GLOBAL(glo_699864, 0x00699864); // = 2.0f
MC2_DEF_GLOBAL(glo_69B658, 0x0069B658); // = 0.2f
MC2_DEF_GLOBAL(glo_699868, 0x00699868); // = 0.22352f
MC2_DEF_GLOBAL(glo_69B69C, 0x0069B69C); // = 44.704f
MC2_DEF_GLOBAL(glo_69B660, 0x0069B660); // = 1.34112f
MC2_DEF_GLOBAL(glo_699888, 0x00699888); // = -1.78816f
MC2_DEF_GLOBAL(glo_69B664, 0x0069B664); // = -26.8224f
MC2_DEF_GLOBAL(glo_69B65C, 0x0069B65C); // = -1.78816f * 3.0f
MC2_DEF_GLOBAL(glo_69985C, 0x0069985C); // = -26.8224f
MC2_DEF_GLOBAL(glo_69B748, 0x0069B748); // = 5.0f / 6.0f
MC2_DEF_GLOBAL(glo_69B78C, 0x0069B78C); // = sqrt_12_constant
MC2_DEF_GLOBAL(glo_69C7A8, 0x0069C7A8); // = sqrt_12_constant
MC2_DEF_GLOBAL(glo_69C7AC, 0x0069C7AC); // = sqrt_12_constant
MC2_DEF_GLOBAL(glo_69C7B0, 0x0069C7B0); // = sqrt_12_constant
MC2_DEF_GLOBAL(glo_69C7B4, 0x0069C7B4); // = sqrt_12_constant
MC2_DEF_GLOBAL(glo_69C7BC, 0x0069C7BC); // = sqrt_12_constant
MC2_DEF_GLOBAL(glo_69C7C0, 0x0069C7C0); // = sqrt_12_constant
MC2_DEF_GLOBAL(glo_69C7C4, 0x0069C7C4); // = sqrt_12_constant
MC2_DEF_GLOBAL(glo_69C7C8, 0x0069C7C8); // = sqrt_12_constant
MC2_DEF_GLOBAL(glo_69C7CC, 0x0069C7CC); // = sqrt_12_constant
MC2_DEF_GLOBAL(glo_69C7D8, 0x0069C7D8); // = sqrt_12_constant
MC2_DEF_GLOBAL(glo_69C7E0, 0x0069C7E0); // = sqrt_12_constant
MC2_DEF_GLOBAL(glo_6C2600, 0x006C2600); // = sqrt_12_constant
MC2_DEF_GLOBAL(glo_6C39A4, 0x006C39A4); // = 50.0f
MC2_DEF_GLOBAL(glo_6C39A0, 0x006C39A0); // = 90.0f
MC2_DEF_GLOBAL(glo_6C520C, 0x006C520C); // = 1609.344f / 60.0f
MC2_DEF_GLOBAL(glo_6C521C, 0x006C521C); // = sqrt_12_constant
MC2_DEF_GLOBAL(glo_6C5220, 0x006C5220); // = 1.0f / 50.0f
MC2_DEF_GLOBAL(glo_6C9034, 0x006C9034); // = (float) fabs((double) -9.8f)
MC2_DEF_GLOBAL(glo_6C9030, 0x006C9030); // = 0.035f * 0.15f
MC2_DEF_GLOBAL(glo_6C902C, 0x006C902C); // = sqrt_9_8_constant
MC2_DEF_GLOBAL(glo_6CE510, 0x006CE510); // = 1.0f / 330.0f
