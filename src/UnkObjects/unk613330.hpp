...
public:
    ...
    inline file_handle_struct *vir_20(char* unk1, char* unk2, int32_t unk3, int32_t extension){
        return static_cast<unk_613330_vTable*>(vtable)->vir_20(this, unk1, unk2, unk3, extension);
    }
