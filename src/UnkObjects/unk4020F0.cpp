...
unk_4020F0 *sub_402560() {
    glo_692E7C = new unk_4020F0;
    return glo_692E7C;
}

MC2_DEF_PROC(sub_405D50, 0x00405D50);
MC2_DEF_PROC(sub_4069B0, 0x004069B0);
MC2_DEF_PROC(sub_40E240, 0x0040E240);
MC2_DEF_PROC(sub_477EF0, 0x00477EF0);
MC2_DEF_PROC(sub_479100, 0x00479100);
MC2_DEF_PROC(sub_482C60, 0x00482C60);
MC2_DEF_PROC(sub_4CEB00, 0x004CEB00);
MC2_DEF_PROC(sub_52B6C0, 0x0052B6C0);
MC2_DEF_PROC(sub_53C6B0, 0x0053C6B0);
MC2_DEF_PROC(sub_53C9E0, 0x0053C9E0);
MC2_DEF_PROC(sub_53DE60, 0x0053DE60);
MC2_DEF_PROC(sub_5670D0, 0x005670D0);
MC2_DEF_PROC(sub_57E250, 0x0057E250);
