...
MC2_DEF_GLOBAL(glo_69685C, 0x0069685C);
MC2_DEF_GLOBAL(glo_697E24, 0x00697E24);
MC2_DEF_GLOBAL(glo_6C50F0, 0x006C50F0);
MC2_DEF_GLOBAL(glo_6C5224, 0x006C5224);
MC2_DEF_GLOBAL(glo_6CE228, 0x006CE228);
MC2_DEF_GLOBAL(glo_857850, 0x00857850);
MC2_DEF_GLOBAL(glo_857868, 0x00857868);
MC2_DEF_GLOBAL(glo_858288, 0x00858288);
MC2_DEF_GLOBAL(glo_8582AC, 0x008582AC);
MC2_DEF_GLOBAL(glo_8586B8, 0x008586B8);
MC2_DEF_GLOBAL(glo_85ADDC, 0x0085ADDC);
MC2_DEF_GLOBAL(glo_85AE60, 0x0085AE60);
MC2_DEF_GLOBAL(glo_8600F8, 0x008600F8);

MC2_DEF_GLOBAL(glo_8600E8, 0x008600E8);
